...
//                resetSession()
                ...
                if let boxNode = boxScene.rootNode.childNode(withName: "portal", recursively: true) {
                    ...
                    boxNode.position = SCNVector3(x: hitResult.worldTransform.columns.3.x, y: hitResult.worldTransform.columns.3.y + 0.05, z: hitResult.worldTransform.columns.3.z - 2)
